...
public class HTTP {
    public static void main(String[] args) {
        ...
        String valid = (statusCode==200)?"Ok":(statusCode==201)?"Created":(statusCode==202)?"Accepted":(statusCode==301)?"Moved Permanently"
        ...
        :(statusCode==503)?"Service Unavailable":"invalid number";
