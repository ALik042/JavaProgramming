...
1. create a class named Castings
            ...
            1.2 declare the following variables and assign averageScore to each of them:
                             ...
                             implicit casting: smaller type to large
                             explicit casting: large type to small
                             float and double accept decimal
                             double > float > long > int > short > byte

                             there is only way assign large to smaller type explicit
 */